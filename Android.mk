...
$(WIFI_FIRMWARE_SYMLINKS): $(LOCAL_INSTALLED_MODULE)
	...
	$(hide) ln -sf /mnt/vendor/persist/qca_cld/wlan_mac.bin $@/wlan_mac.bin
...
ALL_DEFAULT_INSTALLED_MODULES += $(RFS_MSM_SLPI_SYMLINKS) $(RFS_MSM_MPSS_SYMLINKS) $(RFS_MSM_CDSP_SYMLINKS) $(RFS_MSM_ADSP_SYMLINKS)

QDMA_SYMLINKS := $(TARGET_OUT_VENDOR)/app/QDMA/
$(QDMA_SYMLINKS): $(LOCAL_INSTALLED_MODULE)
	@echo "Creating QDMA folder structure: $@"
	@rm -rf $@/*
	@mkdir -p $(dir $@)/lib/arm64/vendor/lib64
	$(hide) ln -sf /vendor/lib64/libvndfwk_detect_jni.qti.so $@/lib/arm64/libvndfwk_detect_jni.qti.so

QDMAUI_SYMLINKS := $(TARGET_OUT_VENDOR)/app/QDMA-UI/
$(QDMAUI_SYMLINKS): $(LOCAL_INSTALLED_MODULE)
	@echo "Creating QDMA-UI folder structure: $@"
	@rm -rf $@/*
	@mkdir -p $(dir $@)/lib/arm64/vendor/lib64
	$(hide) ln -sf /vendor/lib64/libvndfwk_detect_jni.qti.so $@/lib/arm64/libvndfwk_detect_jni.qti.so

ALL_DEFAULT_INSTALLED_MODULES += $(QDMA_SYMLINKS) $(QDMAUI_SYMLINKS)
